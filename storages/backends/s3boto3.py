...
class S3Boto3Storage(Storage):
    ...
    session_token_names = ['AWS_SESSION_TOKEN']

    access_key = setting('AWS_S3_ACCESS_KEY_ID', setting('AWS_ACCESS_KEY_ID'))
    secret_key = setting('AWS_S3_SECRET_ACCESS_KEY', setting('AWS_SECRET_ACCESS_KEY'))
    session_token = setting('AWS_SESSION_TOKEN')
    ...
    def __init__(self, acl=None, bucket=None, **settings):
        ...
        if not self.access_key and not self.secret_key:
            self.access_key, self.secret_key, self.session_token = self._get_access_keys()
    ...
    def _get_access_keys(self):
        ...
        session_token = self.session_token or lookup_env(self.session_token_names)
